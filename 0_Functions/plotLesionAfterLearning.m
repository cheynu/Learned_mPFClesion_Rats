...
plot(fplist-0.05, RelTMedPreMean, 'o-', 'linewidth', 1, 'color', 'k', 'markerfacecolor', 'k', 'markeredgecolor','w', 'markersize', 5)
line([fplist; fplist]-0.05, [RelTMedPreMean-RelTMedPreSEM; RelTMedPreMean+RelTMedPreSEM], ...
    'color','k', 'linewidth', 1)

plot(fplist+0.05, RelTMedPostMean, 'o-', 'linewidth', 1, 'color', cOrange, 'markerfacecolor', cOrange, 'markeredgecolor','w', 'markersize', 5)
line([fplist; fplist]+0.05, [RelTMedPostMean-RelTMedPostSEM; RelTMedPostMean+RelTMedPostSEM], ...
...
set(ha33, 'units', 'centimeters', 'position', [xs2(3) ys(3) size1], 'nextplot', 'add','tickDir', 'out',...
    'xlim',[fplist(1)-0.25,fplist(end)+0.25],'xtick',fplist,'xticklabel',cellstr(string(fplist.*1000)),'fontsize',7, ...
    'ylim',[0.2 0.9],'ytick',0.2:0.2:0.8,'yticklabels',{'200','400','600','800'},'ticklength', [0.02 0.025]);
lpre = plot(fplist-0.05, RelTMedPreMean, 'o-', 'linewidth', 1, 'color', 'k', 'markerfacecolor', 'k', 'markeredgecolor','w', 'markersize', 5);
line([fplist; fplist]-0.05, [RelTMedPreMean-RelTMedPreSEM; RelTMedPreMean+RelTMedPreSEM], ...
    'color','k', 'linewidth', 1)
lpost = plot(fplist+0.05, RelTMedPostMean, 'o-', 'linewidth', 1, 'color', cOrange, 'markerfacecolor', cOrange, 'markeredgecolor','w', 'markersize', 5);
line([fplist; fplist]+0.05, [RelTMedPostMean-RelTMedPostSEM; RelTMedPostMean+RelTMedPostSEM], ...
    'color',cOrange, 'linewidth', 1)
xlabel('Foreperiod (ms)','Fontsize',8,'FontName','Arial')
ylabel('Reaction time (ms)','Fontsize',8,'FontName','Arial')
